...
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_27_appendContainer,"hx.widgets.DataViewTreeCtrl","appendContainer",0x191b83ee,"hx.widgets.DataViewTreeCtrl.appendContainer","hx/widgets/DataViewTreeCtrl.hx",27,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_40_appendItem,"hx.widgets.DataViewTreeCtrl","appendItem",0x8c0c3586,"hx.widgets.DataViewTreeCtrl.appendItem","hx/widgets/DataViewTreeCtrl.hx",40,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_57_get_imageList,"hx.widgets.DataViewTreeCtrl","get_imageList",0xb7480957,"hx.widgets.DataViewTreeCtrl.get_imageList","hx/widgets/DataViewTreeCtrl.hx",57,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_60_set_imageList,"hx.widgets.DataViewTreeCtrl","set_imageList",0xfc4deb63,"hx.widgets.DataViewTreeCtrl.set_imageList","hx/widgets/DataViewTreeCtrl.hx",60,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_69_getItemText,"hx.widgets.DataViewTreeCtrl","getItemText",0xd009627d,"hx.widgets.DataViewTreeCtrl.getItemText","hx/widgets/DataViewTreeCtrl.hx",69,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_74_setItemText,"hx.widgets.DataViewTreeCtrl","setItemText",0xda766989,"hx.widgets.DataViewTreeCtrl.setItemText","hx/widgets/DataViewTreeCtrl.hx",74,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_81_setItemIconIndex,"hx.widgets.DataViewTreeCtrl","setItemIconIndex",0xaba9b27d,"hx.widgets.DataViewTreeCtrl.setItemIconIndex","hx/widgets/DataViewTreeCtrl.hx",81,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_85_deleteAllItems,"hx.widgets.DataViewTreeCtrl","deleteAllItems",0xc5bea863,"hx.widgets.DataViewTreeCtrl.deleteAllItems","hx/widgets/DataViewTreeCtrl.hx",85,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_89_deleteChildren,"hx.widgets.DataViewTreeCtrl","deleteChildren",0x7b385683,"hx.widgets.DataViewTreeCtrl.deleteChildren","hx/widgets/DataViewTreeCtrl.hx",89,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_93_deleteItem,"hx.widgets.DataViewTreeCtrl","deleteItem",0xd14d1057,"hx.widgets.DataViewTreeCtrl.deleteItem","hx/widgets/DataViewTreeCtrl.hx",93,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_97_isContainer,"hx.widgets.DataViewTreeCtrl","isContainer",0x9e13885e,"hx.widgets.DataViewTreeCtrl.isContainer","hx/widgets/DataViewTreeCtrl.hx",97,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_101_getChildCount,"hx.widgets.DataViewTreeCtrl","getChildCount",0x114d95f0,"hx.widgets.DataViewTreeCtrl.getChildCount","hx/widgets/DataViewTreeCtrl.hx",101,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_104_getNthChild,"hx.widgets.DataViewTreeCtrl","getNthChild",0xff7e97f7,"hx.widgets.DataViewTreeCtrl.getNthChild","hx/widgets/DataViewTreeCtrl.hx",104,0xff77a7c7)
HX_LOCAL_STACK_FRAME(_hx_pos_39ebb083e28b6be6_115_get_dataViewTreeCtrlRef,"hx.widgets.DataViewTreeCtrl","get_dataViewTreeCtrlRef",0x16dfb3b9,"hx.widgets.DataViewTreeCtrl.get_dataViewTreeCtrlRef","hx/widgets/DataViewTreeCtrl.hx",115,0xff77a7c7)
namespace hx{
namespace widgets{
...
HXLINE(  53)		this->_imageList = null();
HXLINE(  16)		if (::hx::IsNull( this->_ref )) {
HXLINE(  17)			this->_ref = ::cpp::Pointer_obj::fromRaw((new wxDataViewTreeCtrl()))->reinterpret();
HXLINE(  18)			if ((style == 0)) {
HXLINE(  19)				style = ::wx::widgets::styles::DataViewCtrlStyle_obj::DV_NO_HEADER;
            			}
HXLINE(  21)			 wxDataViewTreeCtrl * _hx_tmp = this->get_dataViewTreeCtrlRef()->ptr;
...
HXDLIN(  21)			(*(_hx_tmp)).Create(_hx_tmp1,id,_hx_tmp2,_hx_tmp3,style);
            		}
...
bool DataViewTreeCtrl_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::hx::widgets::DataViewItem DataViewTreeCtrl_obj::appendContainer( ::hx::widgets::DataViewItem parent,::String text,::hx::Null< int >  __o_icon,::hx::Null< int >  __o_expanded){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_39ebb083e28b6be6_27_appendContainer)
HXLINE(  28)		const char* this1 = text.utf8_str();
HXDLIN(  28)		 wxString s = wxString::FromUTF8(this1);
HXLINE(  29)		 ::hx::widgets::DataViewItem newItem =  ::hx::widgets::DataViewItem_obj::__alloc( HX_CTX );
HXLINE(  30)		if (::hx::IsNull( parent )) {
HXLINE(  31)			 wxDataViewTreeCtrl * _hx_tmp = this->get_dataViewTreeCtrlRef()->ptr;
HXDLIN(  31)			newItem->_item = (*(_hx_tmp)).AppendContainer(wxDataViewItem(0),s,icon,expanded);
            		}
            		else {
HXLINE(  33)			 wxDataViewItem parentItem = parent->_item;
HXLINE(  34)			newItem->_item = this->get_dataViewTreeCtrlRef()->ptr->AppendContainer(parentItem,s,icon,expanded);
            		}
HXLINE(  37)		return newItem;
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(DataViewTreeCtrl_obj,appendContainer,return )
 ...
 ::hx::widgets::DataViewItem DataViewTreeCtrl_obj::appendItem( ::hx::widgets::DataViewItem parent,::String text,::hx::Null< int >  __o_icon){
            		int icon = __o_icon.Default(-1);
            	HX_GC_STACKFRAME(&_hx_pos_39ebb083e28b6be6_40_appendItem)
HXLINE(  41)		const char* this1 = text.utf8_str();
HXDLIN(  41)		 wxString s = wxString::FromUTF8(this1);
HXLINE(  42)		 ::hx::widgets::DataViewItem newItem =  ::hx::widgets::DataViewItem_obj::__alloc( HX_CTX );
HXLINE(  43)		if (::hx::IsNull( parent )) {
HXLINE(  44)			 wxDataViewTreeCtrl * _hx_tmp = this->get_dataViewTreeCtrlRef()->ptr;
HXDLIN(  44)			newItem->_item = (*(_hx_tmp)).AppendItem(wxDataViewItem(0),s,icon);
            		}
            		else {
HXLINE(  46)			 wxDataViewItem parentItem = parent->_item;
HXLINE(  47)			newItem->_item = this->get_dataViewTreeCtrlRef()->ptr->AppendItem(parentItem,s,icon);
            		}
HXLINE(  50)		return newItem;
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(DataViewTreeCtrl_obj,appendItem,return )
 ...
 ::hx::widgets::ImageList DataViewTreeCtrl_obj::get_imageList(){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_57_get_imageList)
HXDLIN(  57)		return this->_imageList;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DataViewTreeCtrl_obj,get_imageList,return )
 ...
 ::hx::widgets::ImageList DataViewTreeCtrl_obj::set_imageList( ::hx::widgets::ImageList value){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_60_set_imageList)
HXLINE(  61)		if (::hx::IsNotNull( this->_imageList )) {
HXLINE(  62)			this->_imageList->destroy();
            		}
HXLINE(  64)		this->_imageList = value;
HXLINE(  65)		 wxDataViewTreeCtrl * _hx_tmp = this->get_dataViewTreeCtrlRef()->ptr;
HXDLIN(  65)		(*(_hx_tmp)).SetImageList(value->get_imagelistRef()->get_raw());
...
::String DataViewTreeCtrl_obj::getItemText( ::hx::widgets::DataViewItem item){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_69_getItemText)
HXLINE(  70)		 wxString r = this->get_dataViewTreeCtrlRef()->ptr->GetItemText(item->_item);
HXLINE(  71)		return ::String(::String(r.ToUTF8().data()));
            	}
...
void DataViewTreeCtrl_obj::setItemText( ::hx::widgets::DataViewItem item,::String text){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_74_setItemText)
HXLINE(  75)		const char* this1 = text.utf8_str();
HXDLIN(  75)		 wxString s = wxString::FromUTF8(this1);
HXLINE(  76)		this->get_dataViewTreeCtrlRef()->ptr->SetItemText(item->_item,s);
            	}
...
void DataViewTreeCtrl_obj::setItemIconIndex( ::hx::widgets::DataViewItem item,int iconIndex){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_81_setItemIconIndex)
HXDLIN(  81)		 wxDataViewTreeCtrl * _hx_tmp = this->get_dataViewTreeCtrlRef()->ptr;
HXDLIN(  81)		 wxDataViewItem item1 = item->_item;
HXDLIN(  81)		(*(_hx_tmp)).SetItemIcon(item1,this->_imageList->get_imagelistRef()->ptr->GetIcon(iconIndex));
            	}
...
void DataViewTreeCtrl_obj::deleteAllItems(){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_85_deleteAllItems)
HXDLIN(  85)		this->get_dataViewTreeCtrlRef()->ptr->DeleteAllItems();
            	}
...
void DataViewTreeCtrl_obj::deleteChildren( ::hx::widgets::DataViewItem item){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_89_deleteChildren)
HXDLIN(  89)		this->get_dataViewTreeCtrlRef()->ptr->DeleteChildren(item->_item);
            	}
...
void DataViewTreeCtrl_obj::deleteItem( ::hx::widgets::DataViewItem item){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_93_deleteItem)
HXDLIN(  93)		this->get_dataViewTreeCtrlRef()->ptr->DeleteItem(item->_item);
            	}
...
bool DataViewTreeCtrl_obj::isContainer( ::hx::widgets::DataViewItem item){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_97_isContainer)
HXDLIN(  97)		return this->get_dataViewTreeCtrlRef()->ptr->IsContainer(item->_item);
            	}
...
int DataViewTreeCtrl_obj::getChildCount( ::hx::widgets::DataViewItem parent){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_101_getChildCount)
HXDLIN( 101)		return this->get_dataViewTreeCtrlRef()->ptr->GetChildCount(parent->_item);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DataViewTreeCtrl_obj,getChildCount,return )
 ...
 ::hx::widgets::DataViewItem DataViewTreeCtrl_obj::getNthChild( ::hx::widgets::DataViewItem parent,int pos){
            	HX_GC_STACKFRAME(&_hx_pos_39ebb083e28b6be6_104_getNthChild)
HXLINE( 105)		 ::hx::widgets::DataViewItem item =  ::hx::widgets::DataViewItem_obj::__alloc( HX_CTX );
HXLINE( 106)		item->_item = this->get_dataViewTreeCtrlRef()->ptr->GetNthChild(parent->_item,pos);
HXLINE( 107)		return item;
            	}
...
::cpp::Pointer<  wxDataViewTreeCtrl > DataViewTreeCtrl_obj::get_dataViewTreeCtrlRef(){
            	HX_STACKFRAME(&_hx_pos_39ebb083e28b6be6_115_get_dataViewTreeCtrlRef)
HXDLIN( 115)		return this->_ref->reinterpret();
            	}
...
static ::hx::StaticInfo *DataViewTreeCtrl_obj_sStaticStorageInfo = 0;
#endif
