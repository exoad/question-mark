...
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_40_setBitmap,"hx.widgets.TaskBarIcon","setBitmap",0x278196ad,"hx.widgets.TaskBarIcon.setBitmap","hx/widgets/TaskBarIcon.hx",40,0xd5fb5a96)
...
HXDLIN(  23)		const char* this1 = tooltip.utf8_str();
HXDLIN(  23)		 wxString _hx_tmp2 = wxString::FromUTF8(this1);
...
void TaskBarIcon_obj::setBitmap( ::hx::widgets::Bitmap bitmap,::String tooltip){
            	HX_GC_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_40_setBitmap)
HXLINE(  41)		 ::hx::widgets::BitmapBundle bitmapBundle =  ::hx::widgets::BitmapBundle_obj::__alloc( HX_CTX ,bitmap);
HXLINE(  42)		 wxTaskBarIcon * _hx_tmp = this->get_taskBarIconRef()->ptr;
HXDLIN(  42)		 wxBitmapBundle & _hx_tmp1 = bitmapBundle->get_bitmapBundleRef()->get_ref();
HXDLIN(  42)		const char* this1 = tooltip.utf8_str();
HXDLIN(  42)		 wxString _hx_tmp2 = wxString::FromUTF8(this1);
HXDLIN(  42)		(*(_hx_tmp)).SetIcon(_hx_tmp1,_hx_tmp2);
            	}
