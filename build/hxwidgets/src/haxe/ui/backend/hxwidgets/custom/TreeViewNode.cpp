...
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_14_set_data,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","set_data",0xfba583ee,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.set_data","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",14,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_23_updateNodeFromData,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","updateNodeFromData",0x53927006,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.updateNodeFromData","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",23,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_38_get_expanded,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","get_expanded",0x49bc4d89,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.get_expanded","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",38,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_46_set_expanded,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","set_expanded",0x5eb570fd,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.set_expanded","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",46,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_60_getNodesInternal,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","getNodesInternal",0x3e5f55df,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.getNodesInternal","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",60,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_74_get_selected,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","get_selected",0x015a66ab,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.get_selected","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",74,0x3be60118)
HX_LOCAL_STACK_FRAME(_hx_pos_066b1635387226d3_80_set_selected,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","set_selected",0x16538a1f,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.set_selected","haxe/ui/backend/hxwidgets/custom/TreeViewNode.hx",80,0x3be60118)
...
bool TreeViewNode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic TreeViewNode_obj::set_data( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_14_set_data)
HXLINE(  15)		if (::hx::IsEq( value,this->_data )) {
HXLINE(  16)			return value;
            		}
HXLINE(  18)		 ::Dynamic r = this->super::set_data(value);
HXLINE(  19)		this->updateNodeFromData();
HXLINE(  20)		return r;
            	}


void TreeViewNode_obj::updateNodeFromData(){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_23_updateNodeFromData)
HXLINE(  24)		bool _hx_tmp;
HXDLIN(  24)		bool _hx_tmp1;
HXDLIN(  24)		if (::hx::IsNotNull( this->treeView )) {
HXLINE(  24)			_hx_tmp1 = ::hx::IsNull( this->dataViewItem );
            		}
            		else {
HXLINE(  24)			_hx_tmp1 = true;
            		}
HXDLIN(  24)		if (!(_hx_tmp1)) {
HXLINE(  24)			_hx_tmp = ::hx::IsNull( this->treeView->get_window() );
            		}
            		else {
...
HXLINE(  28)		 ::hx::widgets::DataViewTreeCtrl treeCtrl = ::hx::TCast<  ::hx::widgets::DataViewTreeCtrl >::cast(this->treeView->get_window());
HXLINE(  29)		::String text = ( (::String)(this->_data->__Field(HX_("text",ad,cc,f9,4c),::hx::paccDynamic)) );
HXLINE(  30)		::String icon = ( (::String)(this->_data->__Field(HX_("icon",79,e7,b2,45),::hx::paccDynamic)) );
HXLINE(  32)		treeCtrl->setItemText(this->dataViewItem,text);
HXLINE(  33)		if (::hx::IsNotNull( icon )) {
HXLINE(  34)			 ::hx::widgets::DataViewItem _hx_tmp = this->dataViewItem;
HXDLIN(  34)			treeCtrl->setItemIconIndex(_hx_tmp,::haxe::ui::backend::hxwidgets::TreeViewIcons_obj::get(this->treeView,icon));
            		}
            	}
...
bool TreeViewNode_obj::get_expanded(){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_38_get_expanded)
HXLINE(  39)		bool _hx_tmp;
HXDLIN(  39)		bool _hx_tmp1;
HXDLIN(  39)		if (::hx::IsNotNull( this->treeView )) {
HXLINE(  39)			_hx_tmp1 = ::hx::IsNull( this->dataViewItem );
            		}
            		else {
HXLINE(  39)			_hx_tmp1 = true;
            		}
HXDLIN(  39)		if (!(_hx_tmp1)) {
HXLINE(  39)			_hx_tmp = ::hx::IsNull( this->treeView->get_window() );
            		}
            		else {
...
HXLINE(  43)		 ::hx::widgets::DataViewTreeCtrl treeCtrl = ::hx::TCast<  ::hx::widgets::DataViewTreeCtrl >::cast(this->treeView->get_window());
HXLINE(  44)		return treeCtrl->isExpanded(this->dataViewItem);
            	}


bool TreeViewNode_obj::set_expanded(bool value){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_46_set_expanded)
...
HXLINE(  52)		if (value) {
HXLINE(  53)			treeCtrl->expand(this->dataViewItem);
            		}
            		else {
HXLINE(  55)			treeCtrl->collapse(this->dataViewItem);
            		}
...
::Array< ::Dynamic> TreeViewNode_obj::getNodesInternal(){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_60_getNodesInternal)
HXLINE(  61)		bool _hx_tmp;
HXDLIN(  61)		bool _hx_tmp1;
HXDLIN(  61)		if (::hx::IsNotNull( this->treeView )) {
HXLINE(  61)			_hx_tmp1 = ::hx::IsNull( this->dataViewItem );
            		}
            		else {
HXLINE(  61)			_hx_tmp1 = true;
            		}
HXDLIN(  61)		if (!(_hx_tmp1)) {
HXLINE(  61)			_hx_tmp = ::hx::IsNull( this->treeView->get_window() );
            		}
            		else {
HXLINE(  61)			_hx_tmp = true;
            		}
HXDLIN(  61)		if (_hx_tmp) {
HXLINE(  62)			return ::Array_obj< ::Dynamic>::__new(0);
            		}
HXLINE(  65)		::Array< ::Dynamic> nodes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  66)		 ::haxe::ui::backend::hxwidgets::builders::TreeViewBuilder builder = ::hx::TCast<  ::haxe::ui::backend::hxwidgets::builders::TreeViewBuilder >::cast(this->treeView->_compositeBuilder);
HXLINE(  67)		::Array< ::Dynamic> internalNodes = builder->dataViewItemChildren(this->dataViewItem);
HXLINE(  68)		{
HXLINE(  68)			int _g = 0;
HXDLIN(  68)			while((_g < internalNodes->length)){
HXLINE(  68)				 ::haxe::ui::backend::hxwidgets::custom::TreeViewNode node = internalNodes->__get(_g).StaticCast<  ::haxe::ui::backend::hxwidgets::custom::TreeViewNode >();
HXDLIN(  68)				_g = (_g + 1);
HXLINE(  69)				nodes->push(node);
            			}
            		}
HXLINE(  71)		return nodes;
            	}


bool TreeViewNode_obj::get_selected(){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_74_get_selected)
HXLINE(  75)		if (::hx::IsNull( this->treeView )) {
HXLINE(  76)			return false;
            		}
HXLINE(  78)		return ::hx::IsInstanceEq( this->treeView->get_selectedNode(),::hx::ObjectPtr<OBJ_>(this) );
            	}


bool TreeViewNode_obj::set_selected(bool value){
            	HX_STACKFRAME(&_hx_pos_066b1635387226d3_80_set_selected)
HXLINE(  81)		if (::hx::IsNull( this->treeView )) {
HXLINE(  82)			return value;
            		}
HXLINE(  85)		this->treeView->set_selectedNode(::hx::ObjectPtr<OBJ_>(this));
