...
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/dialogs.css",a2,cd,71,48),((Float)-2.98000000000000043),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/textinputs.css",09,ed,72,81),((Float)-2.97000000000000064),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/scrollbars.css",c0,4c,46,92),((Float)-2.96000000000000085),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/scrollview.css",65,8e,d9,71),((Float)-2.95000000000000107),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/checkboxes.css",64,26,af,d6),((Float)-2.94000000000000128),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/optionboxes.css",1b,c0,25,17),((Float)-2.93000000000000149),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/ranges.css",89,d4,eb,8e),((Float)-2.92000000000000171),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/progressbars.css",e0,cf,d4,b0),((Float)-2.91000000000000192),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/sliders.css",a9,89,67,aa),((Float)-2.90000000000000213),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/steppers.css",35,68,15,e3),((Float)-2.89000000000000234),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/tabs.css",71,55,ad,07),((Float)-2.88000000000000256),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/listview.css",36,28,9e,75),((Float)-2.87000000000000277),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/dropdowns.css",39,62,eb,fe),((Float)-2.86000000000000298),null());
...
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/switches.css",55,15,2d,15),((Float)-2.84000000000000341),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/calendars.css",6c,a4,7e,64),((Float)-2.83000000000000362),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/menus.css",eb,34,77,27),((Float)-2.82000000000000384),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/accordion.css",7f,cc,f1,db),((Float)-2.81000000000000405),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/propertygrids.css",6f,0d,0f,bd),((Float)-2.80000000000000426),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/frames.css",19,2c,67,9f),((Float)-2.79000000000000448),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/splitters.css",43,3b,0d,c7),((Float)-2.78000000000000469),null());
...
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/rules.css",6e,b0,74,20),((Float)-2.76000000000000512),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/sidebars.css",ca,b8,c4,c1),((Float)-2.75000000000000533),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/cards.css",1a,0b,84,df),((Float)-2.74000000000000554),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/treeviews.css",47,7e,8e,39),((Float)-2.73000000000000576),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/colorpickers.css",15,07,17,3b),((Float)-2.72000000000000597),null());
HXDLIN( 103)			::haxe::ui::themes::ThemeManager_obj::get_instance()->addStyleResource(HX_("default",c1,d8,c3,9b),HX_("haxeui-core/styles/default/last.css",49,7b,91,9d),((Float)-2.71000000000000618),null());
...
HXLINE(  11)		{
HXLINE(  23)			::haxe::ui::Toolkit_obj::_backendProperties->setProp(HX_("haxe.ui.hxwidgets.frame.title",76,d6,8a,78),HX_("Main",59,64,2f,33));
...
HXLINE(  35)			::haxe::ui::util::Defines_obj::set(HX_("wxWidgetsVersion",aa,fa,25,29),HX_("3.2.0",39,7f,fd,7b),null());
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("wxRELEASE_NUMBER",82,7d,be,3a),HX_("0",30,00,00,00),null());
...
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("hxwidgets",1f,43,1f,aa),HX_("1.5.0",fa,9c,32,55),null());
...
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("hxWidgets",ff,6a,70,77),HX_("1.10.0",3e,66,73,34),null());
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("haxeui_hxwidgets",5a,ab,91,12),HX_("1.5.0",fa,9c,32,55),null());
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("haxeui_core",04,3f,41,9a),HX_("1.5.0",fa,9c,32,55),null());
HXDLIN(  35)			::haxe::ui::util::Defines_obj::set(HX_("haxeui-hxwidgets",cc,41,06,84),HX_("1.5.0",fa,9c,32,55),null());
